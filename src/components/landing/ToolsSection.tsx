        ...
        <section id="tools" className="py-32 px-6 bg-zinc-950 border-t border-white/5">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-display font-bold text-5xl md:text-7xl text-white mb-6 uppercase">TOOLS</h2>
                    <p className="text-zinc-400 text-xl font-light leading-relaxed max-w-2xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {tools.map((tool) => (
                        <div key={tool.id} className="group relative p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-sor7ed-brand/50 transition-all duration-300 text-center">
                            ...
                            <h3 className="font-display text-2xl text-white mb-4 group-hover:text-sor7ed-brand transition-colors uppercase">{tool.title}</h3>
                            <p className="text-zinc-400 text-sm leading-relaxed mb-8">{tool.desc}</p>

                            <div className="flex items-center justify-center gap-2 text-sm font-bold uppercase tracking-widest text-white/50 group-hover:text-white transition-colors">
